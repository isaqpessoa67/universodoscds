...
<nav>
    ...
    <div class = "container">
        ...
        <div class = "logo">
         ...
         <div class="boxMaisVendidos">
          <div class="blocks">
          <div class="mais_vendidosBox" id = "diva">
            <div class="cd1">
            <img src="img/didy.jpeg" alt="Blue Banisters" class = "cdPic">
            <div class="textVendidos">
            <h2>Lana Del Rey</h2>
            <p>Did You Know That Theres a Tunnel Under Ocean Blvd</p>
            <p>R$59,99</p>
            <a href="didypage.php">
            ...
            <div class="cd2">
                <img src="img/midnightsbom.png" alt="Midnights" class = "cdPic">
                <div class="textVendidos">
                <h2>Taylor Swift</h2>
                <p>Midnights (The Til Dawn Edition)</p>
                <p>R$59,99</p>
                <a href="midypage.php">
                <input type="button" value="Comprar" class = "button">
                </a>
